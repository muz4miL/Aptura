        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-[#94a3b8] text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
              ...
              design, build, and ship intelligent software — from AI systems
              to full-stack platforms — for businesses that refuse to settle.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section ref={storyRef} className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="relative">
            {/* Vertical line */}
            <div className="absolute left-[18px] top-0 bottom-0 w-px bg-gradient-to-b from-[#00f0ff]/30 via-[#00f0ff]/10 to-transparent hidden md:block" />
              ...
              {timeline.map((item, i) => (
                ...
                >
                  ...
                  <div className="flex-shrink-0 w-[38px] flex flex-col items-center">
                    <div className="w-[10px] h-[10px] rounded-full bg-[#00f0ff] shadow-[0_0_12px_rgba(0,240,255,0.4)]" />
                  </div>

                  {/* Content */}
                  <div className="bg-[#0a0d14] border border-white/[0.06] rounded-2xl p-7 flex-1 hover:border-[#00f0ff]/10 transition-colors duration-300">
                    <span className="text-[#00f0ff]/50 font-mono text-[11px] tracking-[0.2em] uppercase">
                      {item.year}
                    </span>
                    <h3 className="text-white font-heading font-semibold text-xl mt-2 mb-3">
                      {item.title}
                    </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {values.map((val, i) => (
              <motion.div
                ...
                className="group relative bg-[#0a0d14] border border-white/[0.06] rounded-2xl p-7 hover:border-[#00f0ff]/15 transition-all duration-300 overflow-hidden"
              >
                {/* Hover glow */}
                <div
                  ...
                  style={{
                    background:
                      "radial-gradient(ellipse at 20% 80%, rgba(0,240,255,0.05) 0%, transparent 60%)",
                  }}
                />

                <div className="relative z-10">
                  <div className="w-11 h-11 flex items-center justify-center rounded-xl bg-[#00f0ff]/[0.06] border border-[#00f0ff]/10 text-[#00f0ff]/70 group-hover:text-[#00f0ff] group-hover:border-[#00f0ff]/20 transition-all duration-300 text-base mb-5">
                    {val.icon}
                  </div>
                  <h3 className="text-white font-heading font-semibold text-[16px] mb-3 group-hover:text-[#00f0ff] transition-colors duration-300">
                    {val.title}
                  </h3>
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <blockquote className="text-2xl md:text-3xl lg:text-4xl font-heading font-bold text-white leading-snug mb-8">
            &ldquo;To create digital solutions that are fast, reliable, and
            genuinely useful —{" "}
            <span className="gradient-text">
              built with care, for real users.
            </span>
            &rdquo;
          </blockquote>
          ...
          <p className="text-[#94a3b8]/70 text-base max-w-2xl mx-auto leading-relaxed">
            ...
            problems and delivers meaningful impact — not just features, but
